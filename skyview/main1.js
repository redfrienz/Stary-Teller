...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function initThreeJS() {
        ...
        addMilkyWayTexture(192.86, 27.128, 265.3);
...
let ownConstellationData = JSON.parse(localStorage.getItem('ownConstellation1')) || [];

let selectedStars = [];

// Function to save astronaut data to local storage
function saveOwnConstellationData() {
    localStorage.setItem('ownConstellation1', JSON.stringify(ownConstellationData));
}
...
loadButton.addEventListener('click', () => {
    ownConstellationData = JSON.parse(localStorage.getItem('ownConstellation1')) || [];
...
resetButton.addEventListener('click', () => {
    localStorage.removeItem('ownConstellation1');
    localStorage.removeItem('constellationNames1');
    ownConstellationData = [];
...
let constellationNamesData = JSON.parse(localStorage.getItem('constellationNames1')) || [];
...
function saveConstellationNamesData() {
    localStorage.setItem('constellationNames1', JSON.stringify(constellationNamesData));
}
