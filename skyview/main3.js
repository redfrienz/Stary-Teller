...
let ownConstellationData = JSON.parse(localStorage.getItem('ownConstellation3')) || [];

let selectedStars = [];

// Function to save astronaut data to local storage
function saveOwnConstellationData() {
    localStorage.setItem('ownConstellation3', JSON.stringify(ownConstellationData));
}
...
loadButton.addEventListener('click', () => {
    ownConstellationData = JSON.parse(localStorage.getItem('ownConstellation3')) || [];
...
resetButton.addEventListener('click', () => {
    localStorage.removeItem('ownConstellation3');
    localStorage.removeItem('constellationNames3');
    ownConstellationData = [];
...
let constellationNamesData = JSON.parse(localStorage.getItem('constellationNames3')) || [];
...
function saveConstellationNamesData() {
    localStorage.setItem('constellationNames3', JSON.stringify(constellationNamesData));
}
