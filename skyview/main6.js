...
let ownConstellationData = JSON.parse(localStorage.getItem('ownConstellation6')) || [];
...
loadButton.addEventListener('click', () => {
    ownConstellationData = JSON.parse(localStorage.getItem('ownConstellation6')) || [];
...
resetButton.addEventListener('click', () => {
    localStorage.removeItem('ownConstellation6');
    localStorage.removeItem('constellationNames6');
    ownConstellationData = [];
...
let constellationNamesData = JSON.parse(localStorage.getItem('constellationNames6')) || [];
...
function saveConstellationNamesData() {
    localStorage.setItem('constellationNames6', JSON.stringify(constellationNamesData));
}
