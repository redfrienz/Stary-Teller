...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function initThreeJS() {
        ...
        addMilkyWayTexture(192.86, 27.128, 269.9);
...
let ownConstellationData = JSON.parse(localStorage.getItem('ownConstellation8')) || [];

let selectedStars = [];

// Function to save astronaut data to local storage
function saveOwnConstellationData() {
    localStorage.setItem('ownConstellation8', JSON.stringify(ownConstellationData));
}
...
loadButton.addEventListener('click', () => {
    ownConstellationData = JSON.parse(localStorage.getItem('ownConstellation8')) || [];
...
resetButton.addEventListener('click', () => {
    localStorage.removeItem('ownConstellation8');
    localStorage.removeItem('constellationNames8');
    ownConstellationData = [];
...
let constellationNamesData = JSON.parse(localStorage.getItem('constellationNames8')) || [];
...
function saveConstellationNamesData() {
    localStorage.setItem('constellationNames8', JSON.stringify(constellationNamesData));
}
